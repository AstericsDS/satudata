...
final class MOA extends PowerGridComponent
{
    public string $tableName = 'm-o-a-npstzy-table';
    ...
    {
        return Kerjasama::query()->where('jenis_dokumen', 'Memorandum of Agreement (MoA)');
    }
