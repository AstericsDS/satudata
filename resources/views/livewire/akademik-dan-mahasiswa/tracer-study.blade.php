<div class="2xl:mx-24 mx-4 mt-4 mb-8">
    ...
    <div class="flex flex-col 2xl:flex-row gap-4 mt-6">
        ...
        <div class="flex flex-col space-y-4">
            ...
            <div
                class="flex flex-col w-full 2xl:w-sm py-10 space-y-4 bg-linear-to-tr from-primary/70 to-accent-1/70 rounded-md shadow-lg border border-[#1B1B1B]/20">
                ...
                <p class="text-center text-white font-semibold text-md sm:text-lg">Total Akun Alumni</p>
            ...
            <div
                ...
                <p class="text-center text-white font-semibold text-md sm:text-lg">Alumni Mengisi Survey</p>
            ...
            <div
                ...
                <p class="text-center text-white font-semibold text-md sm:text-lg">Tingkat Partisipasi</p>
        ...
        <div class="flex flex-col gap-4 bg-linear-to-b from-primary to-accent-2 from-20% to-100% shadow-lg p-6 rounded-md">
            <h1 class="font-semibold text-lg sm:text-xl text-white">Tracer Study {{ $this->year }}</h1>
            ...
            <div class="bg-white rounded-md p-4 flex flex-col gap-2">
                <h1 class="text-xl sm:text-2xl font-semibold mb-4">Analisis Data</h1>
                ...
                <div class="flex flex-col 2xl:flex-row gap-4 py-8">
                ...
                <div class="bg-primary/10 p-6 rounded-md">
                    <p class="text-sm sm:text-base">Pada tahun akademik {{ $year }}, universitas mencatat total {{ $data['statistik']['current'] }}
