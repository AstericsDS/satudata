        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-primary md:ms-2">Jumlah
                        Mahasiswa</span>
                </div>
            </li>
        </ol>
    ...
    <div class="flex gap-4 mt-6">
        ...
        <div class="border-1 border-[#1B1B1B]/20 p-8 rounded-md bg-white shadow-xl">
            <div class="flex flex-col gap-6">
                ...
                <div x-data="{ jenjang: @entangle('showJenjang'), fakultas: @entangle('showFakultas'), prodi: @entangle('showProdi'), status: @entangle('showStatus') }"
                    ...
                    <ul class="flex flex-col gap-4">
                        ...
                        <li class="transition-all flex flex-col gap-3">
                            <label for="status" class="flex gap-2 items-center">
                                <input id="status" type="checkbox" x-model="status" wire:model.change="showStatus">
                                Status
                            </label>
                            <select wire:model.change="selectedStatus" x-show="status"
                                x-transition:enter="transition ease-out duration-300"
                                x-transition:enter-start="opacity-0 scale-90"
                                x-transition:enter-end="opacity-100 scale-100"
                                x-transition:leave="transition ease-out duration-300"
        ...
        <div class="bg-linear-to-b from-primary to-accent-2 rounded-md flex flex-col gap-4 p-6 w-full">
            <h1 class="text-2xl text-white font-semibold">Jumlah Mahasiswa</h1>
