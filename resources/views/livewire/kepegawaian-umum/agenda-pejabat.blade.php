                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-800 bg-white rounded-lg">
                    ...
                    <tbody>
                        <tr class="bg-white border-b-1 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <button type="button" data-modal-target="detail-agenda-pejabat" data-modal-toggle="detail-agenda-pejabat" class="text-white bg-unj hover:bg-unj/90 active:bg-unj/80 w-[38px] h-[38px] p-0 flex items-center justify-center rounded-[10px]">
